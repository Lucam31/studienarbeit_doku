...
\section{Motivation}
In den letzten Jahren hat die Entwicklung von Fahrassistenzsystemen und autonomen Fahren erheblich zugenommen und ist mittlerweile ein zentrales Thema in der Automobilindustrie. Für viele Autofahrer sind diese Technologien bereits zu einem unverzichtbaren Bestandteil ihres Fahrerlebnisses geworden \cite{InfografikSelbstbestimmteAutofahrer}. 
...
Mithilfe von Sensoren und Kamerasystemen können Fahrassistenzsysteme die Umgebung des Fahrzeugs überwachen und auf potenzielle Gefahren reagieren. Dies ermöglicht es dem Fahrer, sich auf andere Aspekte des Fahrens zu konzentrieren und gleichzeitig ein höheres Maß an Sicherheit zu gewährleisten \cite[S. 65 ff.]{fahrassistenz}. 
...
Aus diesen Zielen ergeben sich folgende Forschungsfragen, die im Rahmen dieser Arbeit beantwortet werden sollen:
\begin{itemize}
    \item Welche Sensoren und Hardwarekomponenten sind für die Implementierung dieser Fahrassistenzsysteme grundlegend erforderlich?
    \item Wie zuverlässig sind Ultraschallsensoren für die Hinderniserkennung bei verschiedenen Materialien und Entfernungen?
    \item Welche Faktoren beeinflussen die Genauigkeit dieser Fahrassistenzsysteme und wie können diese optimiert werden?
    \item Inwiefern lassen sich die entwickelten Fahrassistenzsysteme auf reale Fahrzeuge übertragen und welche Herausforderungen könnten dabei auftreten?
\end{itemize}
