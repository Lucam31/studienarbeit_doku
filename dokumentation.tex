...
\begin{document}
	...
	\setcounter{page}{1}
        ...
        \input{content/02Hardware.tex}
        \input{content/03Software.tex}
        \input{content/04Konzept.tex}
		\input{content/05Umsetzung.tex}
		\input{content/06Testing.tex}
		\input{content/07Fazit.tex}
